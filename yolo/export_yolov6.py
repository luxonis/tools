...
from yolov6.layers.common import RepVGGBlock, Conv, SiLU
...
class YoloV6R2(nn.Module):
    ...
    def forward(self, im, val=False):
        ...
        if isinstance(y, np.ndarray):
            y = torch.tensor(y)
        result1, result2, result3 = y[0, :6400].view((1, 80, 80, 85)), y[0, 6400:8000].view((1, 40, 40, 85)), y[0, 8000:].view((1, 20, 20, 85))
