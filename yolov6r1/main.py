...
async def upload_file(request):
    ...
    if version == "v6":
        try:
            ...
            raise ServerError(message="Error while loading model (This may be caused by trying to convert a newer version of YoloV6 - release 2.0 or 3.0, if that is the case, choose the 'YoloV6 R2 & R3' options)", status_code=517)
    else:
